...
//         for(vote in ballot){
//           var name = ballot[vote];

//             if (voteCount[vote].hasOwnProperty(name) ){
//                 voteCount[vote][name] += 1 ;
//                }
//             else {
//                 voteCount[vote].hasOwnProperty(name) = 1 ;
//                   };
//       }
//     };
// }
...
//   if (!voteCount.counter[votes[voter].counter]){
// voteCount.counter[votes[voter].counter] = 1;
// }else{ voteCount.counter[votes[voter].counter] +=1;
// }
// }
// }
